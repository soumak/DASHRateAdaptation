        ...
        try {
          ...
          if(index == totalFragNo) 
          {
            ...
            printStats();
				...
				if(!thetaIsSet)   //intialize theta used in OSMF
       {
         theta = (arr.length*8)/request_time;
         thetaIsSet = true;
         ...
         next_chunk_fetch_time = chunk_scheduler(est_bandwidth, l_nxt, 10, bitrates);
         
         console.log("Time Est: "+next_chunk_fetch_time);
